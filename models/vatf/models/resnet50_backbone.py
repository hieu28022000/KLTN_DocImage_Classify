...
class ResNet50Classify(tf.keras.models.Model):
    def __init__(self):
        super(ResNet50Classify, self).__init__()
        self.backbone = tf.keras.applications.ResNet50(weights="imagenet", include_top=False)
